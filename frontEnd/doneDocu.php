    ...
    ?>
        ...
        <?php include "nav.php"; ?>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    ?>
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Done Documents | 
                ...
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#docModal">
                
                    <i class=""></i> Add Document
                </button>
                <?php
    include "modal/newdocModal.php";
                    ?>
            </div>
                                ...
                                <table id="example" class="table table-striped" style="width:100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">New Upload</th>
                                            ...
                                            if($accesstype == 1){
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        echo "<td>" . OfficeName($row['officeCreated']) ."</td>";
                                                        ...
                                                        // <a type="button" title="TAGS" data-bs-toggle=
                                                        // "modal" data-bs-target="#ModalSignatoryEdit' . $row['docu_id'] . '" 
                                                        // class="btn button-s btn-sm"><i class="fa fa-pencil-alt"></i></a>  
														

                                                        //Modify by Darren
                                                        $refno = GetData('select referenceNo from documenttransac where docu_id='.$row['docu_id']);
                                                        $is_exist_in_documentdetails = GetData('select referenceNo from documentdetails where referenceNo=\''.$refno.'\'');
                                                        if($is_exist_in_documentdetails){
                                                            echo'<a type="button" title="EDIT SIGNATORY" href="signatories?docu_id='.secureData($row['docu_id']).'&officeCreated='.secureData($row['officeCreated']).'"
                                                            class="btn button-s btn-sm"><i class="fa fa-pencil-alt"></i></a>  ';
                                                        } else {
                                                            // echo' <a type="button" title="TAGS" data-bs-toggle="modal" data-bs-target="#ModalSignatory'.$row['docu_id'].'" class="btn button-s btn-sm"><i class="fa fa-tags"></i></a>  ';
                                                            echo'<a type="button" title="TAG SIGNATORY" href="signatories?docu_id='.secureData($row['docu_id']).'&officeCreated='.secureData($row['officeCreated']).'"
                                                            class="btn button-s btn-sm"><i class="fa fa-tags"></i></a>  ';
                                                        }
                                                       ...
                                                       echo' <a type="button" title="VIEW" data-bs-toggle=
                                                        "modal" data-bs-target="#d'.$row['docu_id'].'" class="btn button-s btn-sm"><i class="fa fa-eye"></i></a>  
                                                    ...
                                                    //   VIEW
                                                        ...
                                                        ';
                                                        if($row['is_mainRecord'] == 0){
                                                            echo'

                                                            <a type="button" title="Send To Main" data-bs-toggle=
                                                            "modal" data-bs-target="#sendTomodal' . $row['docu_id'] . '" class="btn button-s btn-sm"><i class="fa fa-paper-plane"></i></a>
                                                                ';
                                                            }
                                                            echo'
                                                        </td>'
                                                    ...
                                                    echo "<tr><td colspan='9' class='text-center'> data found</td></tr>";
                                                }
                                                ...
                                                $sql = "SELECT * FROM documenttransac where officeCreated ='$id' and dateDeleted is null and is_mainStatus = 7 ";
                                                $result = mysqli_query($conn, $sql);
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        "modal" class="btn button-s btn-sm"><i class="fa fa-file"></i></a>';
                                                    ...
                                                    //   VIEW
                                                        ...
                                                        <a type="button" title="Details" data-bs-toggle=
                                                        "modal" data-bs-target="#doneDetails' . $row['docu_id'] . '" class="btn button-s btn-sm"><i class="fa fa-ellipsis-h"></i></a>  
                                    

                                                        ';
                                                        if($row['is_mainRecord'] == 0){
                                                            echo'
                                                             <a type="button" title="Edit Document" data-bs-toggle=
                                                            "modal" data-bs-target="#officeEdit' . $row['docu_id'] . '" class="btn button-s btn-sm"><i class="fa fa-edit"></i></a>  
