...
<head>
    ...
    <title>eDoctrack - Office Signatory</title>
...
<body id="page-top">
<?php
include "message/errorsignatory.php";
?>
    <!-- Page Wrapper -->
    <div id="wrapper">
...
<div class="card-title">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Offices / Department Signatory | 
            ...
            <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#officeSignModal">
             
                <i class="fas fa-user-plus"></i> Add Signatory
            </button>
            <?php
 include "modal/officesSignModalAuth.php";
                ?>
        </div>
                            ...
                            <table id="example" class="table table-striped" style="width:100%">
                                ...
                                <?php
                                  ...
                                  $sql = "SELECT * FROM officesignatory ";
                                  ...
                                  if (mysqli_num_rows($result) > 0) {
                                      ...
                                      while ($row = mysqli_fetch_assoc($result)) {
                                          ...
                                          echo "<td>" . getPositionName($row['position_id']) . "</td>";
                                          echo "<td>" . OfficeName($row['office_id']) . "</td>";
                                          echo "<td>" . Getcampus($row['office_id']) . "</td>";
                        
                                          echo '<td>     
                         
                                          
                                        <a type="button" title="Remove Users" data-bs-toggle=
                                          "modal" data-bs-target="#officesignModaledit' . $row['os_id'] . '" class="btn btn-success btn-sm"><i class="fas fa-edit"></i></a>
                                      </td>';
                                          ...
                                          include "modal/officesSignModalAuth.php";
                                        //   include "modal/officesModalAuth.php";
