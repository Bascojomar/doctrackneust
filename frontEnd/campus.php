...
<div class="card-title">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Campus | 
            ...
            <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#campusModal">
             
                <i class="fas fa-user-plus"></i> Add Campus
            </button>
            <?php
                                ...
                                <?php
                                  ...
                                  if (mysqli_num_rows($result) > 0) {
                                      ...
                                      while ($row = mysqli_fetch_assoc($result)) {
                                          ...
                                          "modal" data-bs-target="#exampleModaledit' . $row['campus_id'] . '" class="btn btn-success btn-sm"><i class="fas fa-edit"></i></a>
                                      </td>';
