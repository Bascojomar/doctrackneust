...
<div class="card-title">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Document Type  | 
            ...
            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#doctypeModal">
             
                <i class="fas fa-user-plus"></i> Document Type
            </button>
            <?php
 include "modal/doctypeModalAuth.php";
                ?>
        </div>
</div>

                            <table id="example" class="table table-striped table-container" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Document Code</th>
                                        <th>Document Name</th>
                                ...
                                <?php
                                  ...
                                  if (mysqli_num_rows($result) > 0) {
                                      ...
                                      while ($row = mysqli_fetch_assoc($result)) {
                                          ...
                                          "modal" data-bs-target="#doctypeModaledit' . $row['dt_id'] . '" class="btn btn-success btn-sm"><i class="fas fa-edit"></i></a>
                                      </td>';
