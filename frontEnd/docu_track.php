...
<div class="card-title">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Track Document | 
                                ...
                                <table id="example" class="table table-striped" style="width:100%;">
                                    ...
                                    if (isset($_SESSION['user_id'])) {
                                        ...
                                        if ($result->num_rows == 1) {
                                            ...
                                            if($accesstype == 1){
                                                $sql = "SELECT * FROM documentdetails";
                                                ...
                                                $sql = "SELECT * FROM documenttransac where officeCreated ='$id'";
                                                $result = mysqli_query($conn, $sql);
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        echo "<td>" . GetUserCreated($row['userCreated']) ."</td>";
                                                        echo "<td>" . $row['remarks'] . "</td>";
                                                        echo'<td align="center"> <a title="Show barcode" type="button" >
                                                                <i class="fa fa-file" href="javascript:void();" 
                                                                onclick="openCustom(\'viewBarcode.php?docu_id='.$row['docu_id'].'&referenceNo='.$row['referenceNo'].'\',1000,1000);"></i> </a>
                                                            </td>';
                                                        $file_dir = '../pdf/'.$row['fileUpload'];
                                                        echo '<td class="text-center">
                                                        <button type="button" title="Open PDF" onclick="openCustom(\''.
                                                        ...
                                                        "modal" data-bs-target="#exampleModalremove' . $row['user_id'] . '" class="btn button-s btn-sm"><i class="fa fa-tags"></i></a>  
                                                    ...
                                                    //   VIEW
                                                        ...
                                                        <a type="button" title="Remove Users" data-bs-toggle=
                                                        "modal" data-bs-target="#exampleModalremove' . $row['user_id'] . '" class="btn button-s btn-sm"><i class="fa fa-ellipsis-h"></i></a>  
