                                    ...
                                    if (isset($_SESSION['user_id'])) {
                                        ...
                                        if ($result->num_rows == 1) {
                                            ...
                                            if($accesstype == 1 || $accesstype == 6  ){
                                                $sql = "SELECT * FROM documenttransac where is_mainRecord = 1 and is_mainStatus = 3 and dateDeleted is null";
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    //   VIEW
                                                        ...
                                                        echo '<td class="text-center">   ';
                                                            ...
                                                            echo '<span class="badge bg-warning text-dark">Document on process</span>';
                                                ...
                                                $sql = "SELECT * FROM documenttransac where officeCreated ='$id' and is_mainRecord = 1 and is_mainStatus = 3 and dateDeleted is null ";
                                                $result = mysqli_query($conn, $sql);
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    //   VIEW
                                                        ...
                                                        "modal" data-bs-target="#sendTomain' . $row['docu_id'] . '" class="btn button-s btn-sm"><i class="fa fa-edit"></i></a> 
                                                            ...
                                                            echo '<span class="badge bg-warning text-dark">On going process   </span>';
                                                        }
