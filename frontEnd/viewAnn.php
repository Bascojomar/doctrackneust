...
function ajax_fn(url,container_x){
    ...
    ?>
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">View Attachment | 
                                ...
                                <table id="example" class="table table-striped" style="width:100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Attachment Seen</th>
                                    </thead>
                                    <?php
                                    ...
                                    if (isset($_SESSION['user_id'])) {
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                echo "<tr>";
                                                echo "<td class='text-center'>" . $row['attachmentReferenceNo'] . "</td>";
                                        
                                                // Update the button to correctly reference the modal
                                                echo "<td class='text-center'>
                                                        <a type='button' title='Seen' data-bs-toggle='modal' data-bs-target='#viewattachment" . $row['attachmentID'] . "' 
                                                        class='btn button-s btn-sm text-center'>
