                                                ...
                                                if ($accesstype == 1) {
                                                    ...
                                                    if (mysqli_num_rows($result) > 0) {
                                                        ...
                                                        ';
                                                            ...
                                                            $is_exist_in_documentdetails = GetData('select referenceNo from documentdetails where referenceNo=\'' . $row['referenceNo'] . '\'');

                                                            if ($is_exist_in_documentdetails) {
                                                                if ($row['is_mainRecord'] == 0) {
                                                                    echo '<a type="button" title="Send To Main" data-bs-toggle="modal" data-bs-target="#sendTomodal' . $row['docu_id'] . '" class="btn button-s btn-sm"><i class="fa fa-paper-plane"></i></a>';
                                                                }
                                                            } else {
                                                                echo '';
                                                            }
