...
<div class="card-title">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Offices | 
            ...
            <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#officeModal">
             
                <i class="fas fa-user-plus"></i> Add Office
            </button>
            <?php
                                ...
                                <?php
                                  ...
                                  if (mysqli_num_rows($result) > 0) {
                                      ...
                                      while ($row = mysqli_fetch_assoc($result)) {
                                          ...
                                          echo "<td>" . GetCampusname($row['campus']) . "</td>";
                                          ...
                                          "modal" data-bs-target="#officeModaledit' . $row['office_id'] . '" class="btn btn-success btn-sm"><i class="fas fa-edit"></i></a>
                                      </td>';
