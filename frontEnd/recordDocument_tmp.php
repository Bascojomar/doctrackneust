                                    ...
                                    if (isset($_SESSION['user_id'])) {
                                        ...
                                        if ($result->num_rows == 1) {
                                            ...
                                            if($accesstype == 1 || $accesstype == 6  ){
                                                $sql = "SELECT * FROM documenttransac where is_mainRecord = 1 and is_mainStatus = 1 and dateDeleted is null";
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    //   VIEW
                                                        ...
                                                        if($rs['status'] != 3){
                                                                ...
                                                                <a type="button" title="Send To Signatory" data-bs-toggle=
                                                                "modal" data-bs-target="#sendTosignatory' . $row['docu_id'] . '" class="btn button-s btn-sm"><i class="fa fa-paper-plane"></i></a>
                                                                    ';
                                                        }
                                                        else{
                                                            echo '<span style="font-size:11janpx;">Document is on process </span>';
                                                        }
                                                ...
                                                $sql = "SELECT * FROM documenttransac where officeCreated ='$id'  and is_mainStatus = 2 AND is_mainStatus = 2 or is_mainStatus = 1  and dateDeleted is null ";
                                                $result = mysqli_query($conn, $sql);
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    //   VIEW
                                                        ...
                                                        "modal" data-bs-target="#sendTomain' . $row['docu_id'] . '" class="btn button-s btn-sm"><i class="fa fa-paper-plane"></i></a>
                                                            ...
                                                            echo "<span class='badge bg-danger'>Waiting for verification in Main Records</span>";
                                                        }
