...
if ($result && $result->num_rows > 0) {
    ...
    We are pleased to inform you that your document titled “<strong>" . $docusub . "</strong>”  has been released by 
    <strong>" . OfficeName($office) . "</strong>. Please wait for the additional signatories to complete the review of your documents. <br><br>
