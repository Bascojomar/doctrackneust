...
require '../vendor/autoload.php';
    ...
    $checkQuery = "SELECT * FROM documenttransac where referenceNo = '$referenceNo'";
    ...
    $sql = "SELECT * FROM users where offices = $officeCreated";
        ...
        We regret to inform you that your document titled “<strong>" . $docusub . "</strong>” has been rejected by <strong>" . OfficeName($office) . "</strong>. Please find the remarks regarding the rejection below:<br><br>
        [Insert Remarks Here] <br><br>
        We encourage you to address the feedback provided. Should you have any questions or need assistance, please do not hesitate to reach out.<br><br>
        Best regards,<br>
