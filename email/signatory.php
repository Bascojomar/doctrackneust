...
require '../vendor/autoload.php';
    ...
    $sql = "SELECT * FROM users where offices = $officeCreated";
        ...
        Good day!<br><br>
        We are pleased to inform you that your document titled “<strong>" . $docusub . "</strong>” has been forwarded to all relevant signatories by the Main Records. The document is now in process at the respective signatory offices.<br><br>
        Best regards,<br>
