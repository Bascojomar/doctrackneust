...
if ($result && $result->num_rows > 0) {
    ...
    We are pleased to inform you that your document titled “<strong>" . $docusub . "</strong>”  has been obtained. 
    Your document is now awaiting return to the Main Records Office for review and the upload of the updated files. <br><br>

    We appreciate your patience during this process. If you have any questions or need further assistance, please do not hesitate to reach out. <br><br>
