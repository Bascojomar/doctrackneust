                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Document Tracking System v2</h1>
                                    </div>
                                    <form  class="user" action="backEnd/loginAuth.php" method="POST">
                                        ...
                                        <button class="btn btn-primary btn-user btn-block" type="submit" name="loginauth" value="loginauth" >Login</button>
